...
const IsopodStats = ({ difficulty, price, size, hardiness, color }) => {
  ...
  const sizeIcon = {
    "small": <><PagodaLogo className="default-color small" /><span>Small</span></>,
    "medium": <><PagodaLogo className="default-color medium" /><span>Medium</span></>,
    "large": <><PagodaLogo className="default-color large" /><span>Large</span></>,
  };
